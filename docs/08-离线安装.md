...
- 点击这里查看其他离线包
    ...
    - docker-ce [离线包](https://github.com/TimeBye/kubeadm-ha/actions?query=workflow%3A%22Build+base+images%22)
    - kubeadm-ha [离线包](https://github.com/TimeBye/kubeadm-ha/actions?query=workflow%3AOffline)
      ![](https://i.loli.net/2021/01/25/yDjizw5PGWXdAIv.png)
      ![](https://i.loli.net/2021/01/25/MxcFzUuLYW7mqKR.png)
    </details>
### 离线安装 kubernetes 集群
