...
- 搭建集群后有以下两种“样式”显示，请自行选择：
  - 样式一
    ...
    192.168.56.11   Ready    etcd,master,worker   7m25s   v1.15.3
    192.168.56.12   Ready    etcd,master,worker   5m18s   v1.15.3
    192.168.56.13   Ready    etcd,master,worker   5m18s   v1.15.3
    192.168.56.14   Ready    worker               4m37s   v1.15.3
    ```
