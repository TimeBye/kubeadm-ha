...
sudo yum install git python36 sshpass gcc libffi-devel python-devel openssl-devel -y || sudo apt-get install git python3-pip sshpass build-essential libssl-dev libffi-dev python-dev -y
