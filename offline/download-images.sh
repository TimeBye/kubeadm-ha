...
docker tag k8s.gcr.io/kube-apiserver:v1.20.2                 registry.aliyuncs.com/kubeadm-ha/kube-apiserver:v1.20.2
docker tag k8s.gcr.io/kube-controller-manager:v1.20.2        registry.aliyuncs.com/kubeadm-ha/kube-controller-manager:v1.20.2
docker tag k8s.gcr.io/kube-scheduler:v1.20.2                 registry.aliyuncs.com/kubeadm-ha/kube-scheduler:v1.20.2
docker tag k8s.gcr.io/kube-proxy:v1.20.2                     registry.aliyuncs.com/kubeadm-ha/kube-proxy:v1.20.2
...
docker save \
    ...
    registry.aliyuncs.com/kubeadm-ha/kube-apiserver:v1.20.2 \
    registry.aliyuncs.com/kubeadm-ha/kube-controller-manager:v1.20.2 \
    registry.aliyuncs.com/kubeadm-ha/kube-scheduler:v1.20.2 \
    registry.aliyuncs.com/kubeadm-ha/kube-proxy:v1.20.2 \
