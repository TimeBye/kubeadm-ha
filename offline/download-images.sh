...
docker tag k8s.gcr.io/ingress-nginx/controller:v0.41.2       registry.aliyuncs.com/kubeadm-ha/ingress-nginx_controller:v0.41.2
...
docker save \
    ...
    registry.aliyuncs.com/kubeadm-ha/ingress-nginx_controller:v0.41.2 \
